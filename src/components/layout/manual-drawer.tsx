...
function buildSections(M: ManualDrawerMessages): Section[] {
  return [
    {
      id: "step1-settings",
      title: M.step1.title,
...
export function ManualDrawer() {
  ...
  const sections = useMemo(() => buildSections(getMessages(locale).manualDrawer), [locale]);
        ...
        <div className="flex flex-col h-[90vh] sm:max-h-[850px]">
          ...
          <div className="px-10 py-6 bg-white border-t flex flex-col sm:flex-row items-center justify-between gap-4 font-bold shrink-0">
            ...
            <p className="text-[10px] text-slate-400 uppercase tracking-widest">
              &copy; 2026 Mokflw-Lilymag Floxync Project
            </p>
          </div>
        </div>
      </DialogContent>
