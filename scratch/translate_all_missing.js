...
const main = async () => {
    console.log("Starting batch translation process for ALL languages...");
    
    const langs = ['ar', 'de', 'es', 'fr', 'hi', 'id', 'it', 'ja', 'ko', 'ms', 'nl', 'pt', 'ru', 'th', 'vi', 'zh-TW', 'zh'];
    
    for (const lang of langs) {
        console.log(`\n========================================`);
        console.log(`🌍 Checking language: ${lang}`);
        console.log(`========================================`);
        await processFile('en.json', `${lang}.json`, lang);
        await processFile('dashboard-en.json', `dashboard-${lang}.json`, lang);
        await processFile('ribbon-phrase-desc-en.json', `ribbon-phrase-desc-${lang}.json`, lang);
    }
    
    console.log("\nAll languages checked and translated!");
};
