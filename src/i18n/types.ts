...
/** `/dashboard/mobile/*` 매장 모바일 UI (WebView·Capacitor 공통). */
export type MobileShopMessages = {
  layout: { pcHome: string; storeTitle: string };
  nav: { pickupDelivery: string; quickPos: string; newOrder: string };
  header: { refreshAria: string };
  common: {
    loading: string;
    noStore: string;
  ...
  pickup: {
    ...
    prepaid: string;
    productionDone: string;
    productionWait: string;
    statusDone: string;
    confirmReceipt: string;
    orderDatePrefix: string;
    confirmComplete: string;
    toastProductionDone: string;
    toastProductionWait: string;
    toastSaveFailed: string;
    toastCompleteSuccess: string;
    toastCompleteFailed: string;
    toastError: string;
  };
  payment: {
    card: string;
  ...
  pos: {
    ...
    pinStartCategory: string;
    pinFixedHint: string;
    categoryLabel: string;
    pinCategoryDone: string;
    pinCategoryAction: string;
  };
  order: {
    title: string;
    loadProductsFailed: string;
    ...
    saveFailed: string;
    saved: string;
    anniversaryExists: string;
    anniversaryRegistered: string;
    ...
    aiParse: string;
    cardStudioHint: string;
    ribbonPresetsLabel: string;
    recentRibbonPhrases: string;
    ribbonPreview: string;
    noMessageOrder: string;
    paymentPending: string;
    paymentPaid: string;
    cartCountBadge: string;
    categoryItemCount: string;
    cardDesignStudio: string;
  ...
  customer: {
    ...
    contact: string;
    register: string;
    anniversaryFromOrder: string;
    marketingConsent: string;
    usePoints: string;
    useAllPoints: string;
    maxPointsHint: string;
    sheetTitle: string;
    sheetSearchPlaceholder: string;
    sheetLoading: string;
    sheetEmpty: string;
