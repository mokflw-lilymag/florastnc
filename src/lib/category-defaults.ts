...
export const DEFAULT_PRODUCT_CATEGORIES: CategoryData = {
  main: ['꽃다발', '꽃바구니', '식물/화분', '경조화환', '어버이날상품', '기프티콘/기프트상품', '서양란', '동양란', '웨딩상품', '플라워', '플랜트', '화병/화기', '부자재', '자재', '기타'],
  mid: {
    '꽃다발': ['기본형', '대형', '한송이', '돈꽃다발', '에센셜', '프리미엄'],
    '꽃바구니': ['S사이즈', 'M사이즈', 'L사이즈', '오색꽃바구니', '핸들', '돈바구니'],
    '식물/화분': ['공기정화', '관엽', '다육/선인장', '난', '개업/축하용', '행잉'],
    '경조화환': ['축하화환', '근조화환', '오브제', '축하 3단', '근조 3단'],
    '어버이날상품': ['어버이날컬렉션', '카네이션 바구니', '카네이션 박스'],
    '기프티콘/기프트상품': ['기프트컬렉션', '용돈박스', '플라워박스'],
    '서양란': ['호접란', '심비디움', '미니호접', '서양란'],
    '동양란': ['동양란', '철골소심', '옥화'],
    '웨딩상품': ['웨딩컬렉션', '부케', '코사지'],
    '플라워': ['경조화환', '꽃다발', '꽃바구니', '센터피스', '플라워박스', '행사용꽃'],
    '플랜트': ['대품', '동서양난', '소품', '중품'],
    '화병/화기': ['유리병', '세라믹', '바스켓', '화병/화기'],
    '부자재': ['포장지', '리본', '박스', '기타'],
    '자재': ['드라이플라워카드/토퍼', '화병/화기', '원예자재', '포장자재', '바구니'],
    '기타': ['리스', '기타']
  }
};
...
export const DEFAULT_MATERIAL_CATEGORIES: CategoryData = {
  ...
  mid: {
    ...
    "바구니 / 화기": ["도자기", "테라조", "바구니", "유리", "시멘트"],
    "조화": ["소재(그린)", "트리류"],
    "프리저브드": ["폼플라워"],
    "포장 및 부자재": ["화기", "도자기", "유리", "비누꽃", "조화", "리본/텍", "원예자재", "포장지", "부직포", "비닐", "데코자재", "소품", "기타"],
    "기타": ["원예자재", "배송장비", "기타"]
  }
};
